...
const std::unordered_map<ErrorCode, std::string_view> error_strings{
    ...
    {ErrorCode::REPLICA_NOT_READY, "REPLICA_NOT_READY"},
    {ErrorCode::NO_COMPLETE_REPLICA, "NO_COMPLETE_REPLICA"},
...
const std::unordered_map<ErrorCode, std::string_view> error_descriptions{
    ...
    {ErrorCode::INVALID_REPLICA, "The replica configuration is invalid"},
    {ErrorCode::REPLICA_NOT_READY, "The replica is not ready for operations"},
    {ErrorCode::NO_COMPLETE_REPLICA, "No complete replica found for object"},
